...
public class SwitchApp {
     ...
     * stem(has two types linear and tactile). The cherrymx.cherrymx.CherryMXBrand is a SwitchMaker(GateronBrand is also a switch maker)
